...
CELL_CHAR_PLACE_OBSTACLES = (*CELL_WALL_TYPES, CELL_PLATE, CELL_PORTAL, CELL_GATE0, CELL_GATE1, CELL_SAND, CELL_LOCK1, CELL_LOCK2, CELL_VOID, CELL_GLASS, CELL_TRAP0, CELL_TRAP1, CELL_BEAMGN, CELL_BEAMCL)
